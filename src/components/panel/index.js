        ...
        return (
            <Fragment>
                ...
                <div className="panel-container">
                    ...
                    {addWelcomeOpen ? <AddWelcomeForm addModalOpen={addWelcomeOpen} toggleAddModal={this.toggleAddModal} title="welcome" checkExist={checkExist} addData={addData} route={`/Store/${params.locationName}/${params.roomName}/${params.boardName}/panel`} /> : null}
